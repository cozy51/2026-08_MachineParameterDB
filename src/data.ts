...
export const seedData: Series[] = [
  { id:'src350', name:'SRC350', description:'天井搬送台車', models:[
    {id:'src350-m2',name:'SRC350-M2',overrides:{'p4':{}},cargoTypes:[{id:'foup',name:'FOUP',overrides:{}},{id:'reticle',name:'Reticle',overrides:{}}]},
    ...
    },cargoTypes:[{id:'foup',name:'FOUP',overrides:{}},{id:'reticle',name:'Reticle',overrides:{}}]}], parameters:[
  ...
  { id:'hu300', name:'HU300', description:'300mm FOUP移載機', models:[{id:'hu300-m3',name:'HU300-M3',overrides:{},cargoTypes:[{id:'foup',name:'FOUP',overrides:{}}]}], parameters:[
